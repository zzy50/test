...
INPUT_PATH = "classification_230602_163739/truck_4W_ST/"

SAVE_PATH = "classification_230602_163739"
...
imgs = glob(os.path.join(INPUT_PATH, "*.jpg"))
window_name = "qwe"
...
for img_path in imgs:
    ...
    s3 = f"current path : {INPUT_PATH}    End Button : ESC    Next Image Button : ->"
    ...
    end_y = min(start_y + resized_h, text_height)
    end_x = min(start_x + resized_w, text_width)
    text_img[start_y:end_y, start_x:end_x] = resized_img[:end_y-start_y, :end_x-start_x]
